...
import { addProject } from '../fn/project-rest-api/add-project';
import { AddProject$Params } from '../fn/project-rest-api/add-project';
import { deleteProject } from '../fn/project-rest-api/delete-project';
import { DeleteProject$Params } from '../fn/project-rest-api/delete-project';
import { findProjectById } from '../fn/project-rest-api/find-project-by-id';
import { FindProjectById$Params } from '../fn/project-rest-api/find-project-by-id';
import { getAllProjects } from '../fn/project-rest-api/get-all-projects';
import { GetAllProjects$Params } from '../fn/project-rest-api/get-all-projects';
import { getAverageDuration } from '../fn/project-rest-api/get-average-duration';
import { GetAverageDuration$Params } from '../fn/project-rest-api/get-average-duration';
import { getGeoAndRemaining } from '../fn/project-rest-api/get-geo-and-remaining';
import { GetGeoAndRemaining$Params } from '../fn/project-rest-api/get-geo-and-remaining';
import { getProjectProgress } from '../fn/project-rest-api/get-project-progress';
import { GetProjectProgress$Params } from '../fn/project-rest-api/get-project-progress';
import { getStatisticsByStatus } from '../fn/project-rest-api/get-statistics-by-status';
import { GetStatisticsByStatus$Params } from '../fn/project-rest-api/get-statistics-by-status';
import { Project } from '../models/project';
import { updateProject } from '../fn/project-rest-api/update-project';
import { UpdateProject$Params } from '../fn/project-rest-api/update-project';

@Injectable({ providedIn: 'root' })
export class ProjectRestApiService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `updateProject()` */
  static readonly UpdateProjectPath = '/updateProject/{idProject}';
  ...
  static readonly AddProjectPath = '/addProject';
  ...
  static readonly GetStatisticsByStatusPath = '/statisticsByStatus';
...
[key: string]: number;
  ...
  static readonly GetProjectProgressPath = '/progress/{idProject}';
  ...
  static readonly FindProjectByIdPath = '/getProjectById/{idProject}';
  ...
  static readonly GetAllProjectsPath = '/getAllProjects';
  ...
  static readonly GetGeoAndRemainingPath = '/geoAndRemaining/{idProject}';
...
[key: string]: {
  ...
  static readonly GetAverageDurationPath = '/averageDuration';
   ...
   * This method doesn't expect any request body.
   */
  getAverageDuration$Response(params?: GetAverageDuration$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: {
};
}>> {
   ...
   * This method doesn't expect any request body.
   */
  getAverageDuration(params?: GetAverageDuration$Params, context?: HttpContext): Observable<{
[key: string]: {
};
}> {
...
[key: string]: {
  ...
  static readonly DeleteProjectPath = '/deleteProject/{idProject}';
